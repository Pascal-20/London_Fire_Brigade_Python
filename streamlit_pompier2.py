...
pages = ["Introduction", "Jeux de données", "Visualisation", "Machine Learning", "Résultats", "Conclusion"]
...
if page == pages[0] : 
    ...
    st.markdown("* Proposer des solutions pour ameliorer les performances de la brigade")
    ...
    st.markdown("* Modelisation du temps de reponse par Machine Learning avec Scikit Learn")
    ...
    st.write("### Volumétrie :")
    st.write("- Deux jeux de données : Incidents à Londres et Mobilisation des Pompiers.")
    ...
    st.write("* Remplacement des valeurs manquantes selon différentes stratégies par 0 ou No")
    ...
    st.title("Prédiction du temps de réponse des pompiers")
   ...
   # Créer des selectbox pour les colonnes spécifiques
    ...
    if not filtered_df.empty:
        st.write("Temps de réponse prédit :", filtered_df['TravelTimeSeconds'].mean())
    else:
